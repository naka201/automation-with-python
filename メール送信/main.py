...
def folder_process(folder_path, src_file, mail_template):
    ...
    if not day:
        day = def_day
    version = mail_template['variables'].get('version')
    if not version:
        version = ""
...
def main():
    ...
    file = r"C:\Users\lenovo02\Desktop\自動化\メール送信\大会別精算書メール・LINE先一覧.xlsx"

    # YAMLファイルのパス
    yaml_file = r"C:\Users\lenovo02\Desktop\自動化\メール送信\mail_template.yaml"
    ...
    # バッグ大会
    folder_path = r'C:\Users\lenovo02\Desktop\自動化\メール送信\バッグ大会送信pdf'

    # 呉服大会
    #folder_path = r'C:\Users\lenovo02\Desktop\自動化\メール送信\呉服大会送信pdf'

    # 時宝大会
    #folder_path = r'C:\Users\lenovo02\Desktop\自動化\メール送信\時宝大会送信pdf'

    # 平場バッグ市
    #folder_path = r'C:\Users\lenovo02\Desktop\自動化\メール送信\平場バッグ市送信pdf'

    # 平場市
    #folder_path = r'C:\Users\lenovo02\Desktop\自動化\メール送信\平場市送信pdf'
